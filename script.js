document.addEventListener("DOMContentLoaded", () => {
  const links = {
    bacheca: "https://docs.google.com/spreadsheets/d/1UbQNs2-IgDONy94xQluS9kAuVAmyMyh-48bZ8z1u-Ww/edit?gid=0#gid=0",
  ...
  // Aggiorna i link Bacheca al click per evitare cache
  const bachecaIds = ["bachecaTopLink", "bacheca-link", "bachecaButtonLink"];
  bachecaIds.forEach(id => {
    const el = document.getElementById(id);
    if (el) {
      el.addEventListener("click", () => {
        el.href = buildNoCacheUrl(links.bacheca);
      });
    }
  });

  // Se hai ancora un iframe bacheca nella pagina, lascia questo
